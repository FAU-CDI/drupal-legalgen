...
||email|pub_email|E-mail publisher|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'padmal.publisher@mail.com'|
...
||email|sup_email|E-mail support and hosting|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'support.hosting@mail.de'|
...
||tel|contact_access_phone|Phone number contact person accessibility|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'+49 1234 1234567'|
||email|contact_access_email|E-mail contact person accessibility|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'centli.contactperson@mail.de'|
...
||email|sup_email|E-mail support and hosting|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'support@mail.de'|
...
||tel|overs_phone|Phone number enforcement oversight body|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'+49 1234 67890'|
||email|overs_email|E-mail enforcement oversight body|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'beispiellandesamt@email.de'|
...
||tel|sec_off_phone|Phone number data security official|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'+49 1234 567890'|
||String|sec_off_fax|Fax number data security official|<span style="color:IndianRed">&#x2612;</span>|'intl'|'+49 0987 654321'|
||email|sec_off_email|E-mail data security official|<span style="color:DarkCyan">&#x2611;</span>|'intl'|'dilga.dataofficial@mail.de'|
